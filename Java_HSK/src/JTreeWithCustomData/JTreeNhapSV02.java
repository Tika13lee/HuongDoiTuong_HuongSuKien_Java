...
public class JTreeNhapSV02 extends JFrame implements ActionListener, TreeSelectionListener{
	...
	public JTreeNhapSV02() {
		...
		sp.setLeftComponent(scrollList);
	...
	public void addSV() {
		...
		int index = ((DefaultMutableTreeNode) model.getRoot()).getIndex(selectedNode);
	...
	public static void main(String[] args) {
		new JTreeNhapSV02().setVisible(true);;
	}
